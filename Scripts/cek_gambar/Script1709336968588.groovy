...
WebUI.setText(findTestObject('Object Repository/cobaCekGabr/Page_Login  My Website/input_Email_login'), 'asepridwan9322@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/cobaCekGabr/Page_Login  My Website/input_Kata Sandi_password'), 
...
WebUI.click(findTestObject('Object Repository/cobaCekGabr/Page_Survey main page (take survey)  My Website/h2_Isian'))

WebUI.click(findTestObject('cobaCekGabr/Page_Survey main page (take survey)  My Website/sendGambar'))
